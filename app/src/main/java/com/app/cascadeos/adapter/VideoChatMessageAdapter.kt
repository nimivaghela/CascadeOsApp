...
import com.app.cascadeos.databinding.ItemVideoChatMessageBinding
import com.app.cascadeos.model.MessageModel

class VideoChatMessageAdapter() : RecyclerView.Adapter<VideoChatMessageAdapter.ViewHolder>() {
    ...
    init {
        ...
        dataList.add(
            MessageModel(
                "How about that new Italian place on Main Street?",
                isSender = false
            )
        )
        ...
        dataList.add(
            MessageModel(
                "Sorry, I am stuck somewhere else so can't talk right now!",
                isSender = true
            )
        )
    ...
    class ViewHolder(private val itemBinding: ItemVideoChatMessageBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val itemBinding: ItemVideoChatMessageBinding = DataBindingUtil.inflate(
            LayoutInflater.from(parent.context),
            R.layout.item_video_chat_message,
            parent,
            false
        )
